...
```{r}
# locate files
DIR <- system.file("extdata", package = "regsplice")
files_counts <- list.files(DIR, pattern = "^sample[0-9]\\.txt$", full.names = TRUE)
file_truth   <- list.files(DIR, pattern = "^truth\\.txt$", full.names = TRUE)
