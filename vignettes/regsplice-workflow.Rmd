...
Note that if your inputs are already in the form of a `SummarizedExperiment` object (e.g. outputs generated by another package), the `regsplice()` wrapper function can parse this directly (see above). This may be useful when running `regsplice` as part of a pipeline.
