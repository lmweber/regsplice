...
Note that we have used `n = 10` for display purposes in this vignette. The p-values and adjusted p-values (FDRs) in this example are exactly equal to zero due to the strong differential splicing signal in the simulated data set.
