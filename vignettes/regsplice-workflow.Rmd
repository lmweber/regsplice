...
The result is a list containing gene names, p-values for each gene, multiple testing adjusted p-values (Benjamini-Hochberg false discovery rates, FDR), LR test statistics, and degrees of freedom of the LR tests.
...
Functions for tables of results
...
Show some examples of useful plots using external functions.
